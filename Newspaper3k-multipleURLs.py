...
with open(r'C:\Users\Shravya.Shanmukh\Desktop\Verizon2016.csv','r') as f:
    csv_raw_cont=f.read()
...
for each in split_csv:
    ...
    try:
        ...
        myData=[[url,str(i)]]
        out1 = open(r'C:\Users\Shravya.Shanmukh\Desktop\Bad_Links\Links.csv', 'a',encoding='iso-8859-1')
    ...
    regex=r'[^A-Za-z0-9\\ ]'
    out = open(r'C:\Users\Shravya.Shanmukh\Desktop\Output\Link' + str(i) + '_date_' + date[:10] + '.txt', 'w',encoding='iso-8859-1')
